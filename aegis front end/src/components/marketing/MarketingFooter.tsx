        ...
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              ...
              <li><Link to="/signup" className="text-foreground/80 hover:text-foreground">Start free scan</Link></li>
            </ul>
          </div>
          <div>
            <div className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Company</div>
            <ul className="mt-3 space-y-2 text-sm">
              <li><a className="text-foreground/80 hover:text-foreground" href="#">About</a></li>
              <li><a className="text-foreground/80 hover:text-foreground" href="#">Security</a></li>
              <li><a className="text-foreground/80 hover:text-foreground" href="#">Contact</a></li>
            </ul>
          </div>
        </div>
